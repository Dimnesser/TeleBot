...
FAQ_ENTRIES = [
    ...
    ("Как считаются шансы в кейсах?", "Внутри — только реальные брейнроты Steal a Brainrot. Шанс каждого обратно пропорционален его ценности и показан на странице кейса; цена кейса = средний дроп / 0.9."),
    ("Какой шанс в апгрейдере?", "Шанс = ценность вклада / ценность цели, но не меньше 75% и не больше 95%. Исход решает сервер до начала анимации."),
]
