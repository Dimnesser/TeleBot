...
TIER: dict[str, str] = {
    ...
    "Chicleteira Bicicleteira": "T4",
    "Tung Tung Tung Sahur": "T4",
    "Los Tralaleritos": "T5",
    "La Vacca Saturno Saturnita": "T5",
    "Bombombini Gusini": "T7",
    "Frigo Camelo": "T7",
    "Rhino Toasterino": "T7",
    "Bombardiro Crocodilo": "T7",
    "Glorbo Fruttodrillo": "T7",
    "Chimpanzini Bananini": "T7",
    "Ballerina Cappuccina": "T7",
    "Trulimero Trulicina": "T7",
    "Burbaloni Loliloli": "T7",
    "Bandito Bobritto": "T7",
    "Boneca Ambalabu": "T7",
    "Cacto Hipopotamo": "T7",
    "Ta Ta Ta Ta Sahur": "T7",
    "Tric Trac Baraboom": "T7",
    "Cappuccino Assassino": "T7",
    "Brr Brr Patapim": "T7",
    "Talpa Di Fero": "T7",
    "Svinina Bombardino": "T7",
    "Pipi Kiwi": "T7",
    "Trippi Troppi": "T7",
    "Gangster Footera": "T7",
    "Lirilì Larilà": "T7",
